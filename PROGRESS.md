...
## ЗАПЛАНОВАНО / TODO
- [ ] Підтвердити/замінити стокові фото на власні (перевірити, що сюжет відповідає підпису).
- [ ] (Опц.) фонове відео в hero замість фото (готова структура `.hero-media`).
- [ ] Звірити реальні соц-акаунти та номер телефону/адресу/координати карти.
