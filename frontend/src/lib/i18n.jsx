...
const dict = {
  uk: {
    ...
    admin: {
      ...
      panel: 'Панель записів', loginTitle: 'Вхід',
      loginHint: 'Введіть адмін-токен, щоб переглянути записи. Токен зберігається лише в цій вкладці.',
      tokenLabel: 'Адмін-токен', enter: 'Увійти', checking: 'Перевіряю…',
      title: 'Записи', empty: 'Поки що записів немає.',
      colDate: 'Дата · Час', colClient: 'Клієнт', colPhone: 'Телефон', colService: 'Послуга',
      colBarber: 'Майстер', colCreated: 'Створено', anyBarber: 'будь-який',
      errToken: 'Невірний токен доступу.', errLoad: 'Не вдалося завантажити записи: {msg}', locale: 'uk-UA',
    },
  },
  ...
  en: {
    ...
    admin: {
      ...
      panel: 'Bookings panel', loginTitle: 'Sign in',
      loginHint: 'Enter the admin token to view bookings. The token is stored only in this tab.',
      tokenLabel: 'Admin token', enter: 'Sign in', checking: 'Checking…',
      title: 'Bookings', empty: 'No bookings yet.',
      colDate: 'Date · Time', colClient: 'Client', colPhone: 'Phone', colService: 'Service',
      colBarber: 'Barber', colCreated: 'Created', anyBarber: 'any',
      errToken: 'Invalid access token.', errLoad: 'Could not load bookings: {msg}', locale: 'en-GB',
    },
  },
}
